				...
				<div class="row-fluid">
					<div class="widget widget-padding span12">
						...
						<div class="widget-body">
							<form action=SelectInHouseServlet method="post">
								<div class="form-group">
									<div class="field label-block">
										<!-- <h4>
											<input name="HouseKey" type="input" value="sid">仓库编码
										</h4>
										<br> -->
										 <input name="searchInput" class="span7"  type="text" placeholder="入库订单编码">
